...
def run_seed():
    ...
    try:
        ...
        if "IXR" in airport_map:
            seed_ixr_production_packages(db, airport_map["IXR"], service_map)

        if "GOX" in airport_map:
            seed_gox_production_packages(db, airport_map["GOX"], service_map)
